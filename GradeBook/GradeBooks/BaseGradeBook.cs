...
namespace GradeBook.GradeBooks {
	public abstract class BaseGradeBook {
		...
		public virtual double GetGPA (char letterGrade, StudentType studentType, bool isWiethed) {
			if (isWiethed == true)
			{
				switch (letterGrade)
				{
		...
		public virtual void CalculateStatistics () {
			...
			foreach (var student in Students) {
				...
				student.GPA = GetGPA (student.LetterGrade, student.Type, student.IsWeighted);
